...
t=tN(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const t_=k.toFlatObject(k,{},null,function(t){return/^is[A-Z]/.test(t)});var tP=/**
...
const tY=k.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
